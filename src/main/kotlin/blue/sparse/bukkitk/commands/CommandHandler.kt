...
object CommandHandler
{
	...
	init
	{
		...
		PluginDisableEvent.getHandlerList().register(RegisteredListener(object: Listener {}, EventExecutor { _, event ->
		...
		}, EventPriority.NORMAL, JavaPlugin.getProvidingPlugin(javaClass), true))
	}
